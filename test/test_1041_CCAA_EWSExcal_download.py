...
def test_1041_CCAA_EWSExcal_download():
    global web
    ...
    web.get('https://lms.ncu.edu.tw/q?pg=admin_academic_alert_zone&tg=CCAA-searchZone&cx=22.2000&reportType=4')
    Login()
    ...
    division.click()
    sleep(1)
    department = web.find_element_by_xpath('//*[@id="department"]/option[2]')
    department.click()
    Sbutton = web.find_element_by_xpath('//*[@id="successRate"]/div/div[4]/span')
    Sbutton.click()
    try:
