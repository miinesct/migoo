...
def test_1041_CCAA_WSQExcal_download():
    global web
    ...
    web.get('https://lms.ncu.edu.tw/q?pg=admin_academic_alert_zone&tg=CCAA-searchZone&cx=22.2000&reportType=3')
    Login()
    ...
    department.click()
    sleep(1)
    Sbutton = web.find_element_by_xpath('//*[@id="setQuery"]/div/div[4]/span[2]')
    Sbutton.click()
    try:
